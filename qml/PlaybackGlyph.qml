...
Item {
    id:glyph;objectName:"playbackGlyph"
    // The outline below is drawn on Material Symbols' 24dp grid and scaled to
    // the icon size of the button carrying it (32dp on a large icon button).
    ...
    Shape {width:24;height:24;scale:glyph.size/24;transformOrigin:Item.TopLeft;visible:morph.running
