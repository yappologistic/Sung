...
MDialog {
    ...
    signal chooseFile()
    onPreviewChanged: {if(body.item)body.item.resetCrop();failure=preview?"":"Choose a PNG, JPEG or WebP image";}
    onClosed: preview=""
    ...
    Loader {
        ...
        sourceComponent: ColumnLayout {
            function resetCrop() {horizontal.value=0.5;vertical.value=0.5;zoom.value=1;}
