...
QtObject {
    ...
    readonly property bool visible: exportPicker.visible || importPicker.visible || cookiePicker.visible || lyricPicker.visible || audioPicker.visible || locatePicker.visible || folderPicker.visible
    function open(kind) {
        if(kind === "folder") folderPicker.open();
