    ...
    ColumnLayout {
        ...
        RowLayout {
            ...
            ColumnLayout {
                ...
                Artwork { id: immersiveArt; objectName: "immersiveArtwork"; Layout.preferredWidth: player.coverSize; Layout.preferredHeight: player.coverSize; Layout.maximumHeight: player.coverSize; url: presentation.shown.art || ""; motionUrl: presentation.shown.id === app.current.id ? app.currentMotionArt : (presentation.shown.motionArt || ""); opacity: player.coverHidden?0:presentation.fade; radius: 28; pixels: 850; highResolution: true; fit: {app.currentArtworkFit;return app.artworkFits(presentation.shown)} }
        ...
        RowLayout {
            ...
            MButton { objectName: "immersivePlayButton"; busy: app.buffering; symbol: app.playing||app.resolving?"pause":"play"; filled: true; implicitWidth: 80; implicitHeight: 56; tip: app.playing||app.resolving?"Pause":"Play"; enabled: app.queue.count>0; onClicked: app.toggle() }
