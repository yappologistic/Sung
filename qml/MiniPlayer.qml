...
Window {
    ...
    Rectangle {
        ...
        SungText { anchors.left: parent.left; anchors.right: retry.left; anchors.verticalCenter: parent.verticalCenter; anchors.margins: 16; text: app.error; color: Theme.errorContainerText; font.pixelSize: Theme.bodySmall }
