...
RowLayout {
    ...
    MWavySlider {objectName:"inlineVolumeSlider";visible:control.showSlider;Layout.preferredWidth:66}
    Popup {
        ...
        ColumnLayout {anchors.fill:parent;spacing:8
            ...
            MWavySlider {objectName:control.sliderName;inactiveColor:Theme.outlineVariant;Layout.fillWidth:true;onMoved:percent.text=String(Math.round(value*100))}
            RowLayout {Layout.fillWidth:true
