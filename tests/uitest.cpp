...
void runVisualRefinementTests(Backend *b,QQuickWindow *w){
  ...
  QTest::qWait(250);shot("07-home-editor");click("homeLayoutReset");check(b->homeOrder().isEmpty()&&b->hiddenHomeSections().isEmpty(),"Home layout resets");if(editor)QMetaObject::invokeMethod(editor,"close");QTest::qWait(250);
